...
import { RiBillFill, RiDashboardHorizontalFill, RiResetLeftFill } from "react-icons/ri";
...
export const ListFunctionHome = () => {
    const items = [
      ...
      return (
        <div style={{ display: 'flex', flexDirection: 'column', paddingTop: '25px', paddingLeft: '10px' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: '10px',
                  backgroundColor: isHovered ? 'rgba(190, 190, 190, 0.1)' : 'transparent',
              ...
              >
                <IconComponent
                  ...
                  style={{ width: isHovered ? '20px' : '17px', height: isHovered ? '20px' : '17px' }}
                />
                <span style={{ fontSize: '13px', color: 'white' }}>{item.title}</span>
              </div>
            );
          })}
        </div>
